...
from opta import __version__, urls, utils
from opta.dump import dump  # noqa: F401

opta_user_agent = f"Opta/{__version__} +{urls.website}"
...
def install_playwright(io):
    ...
    pip_cmd = utils.get_pip_install(["opta-chat[playwright]"])
...
class Scraper:
    ...
    def scrape_with_httpx(self, url):
        ...
        headers = {"User-Agent": f"Mozilla./5.0 ({opta_user_agent})"}
        try:
            with httpx.Client(
