...
from opta.args_formatter import (
    DotEnvFormatter,
    MarkdownHelpFormatter,
    YamlHelpFormatter,
)
from opta.deprecated import add_deprecated_model_args

from .dump import dump  # noqa: F401


def resolve_optaignore_path(path_str, git_root=None):
    path = Path(path_str)
    if path.is_absolute():
        return str(path)
    elif git_root:
...
def get_parser(default_config_files, git_root):
    parser = configargparse.ArgumentParser(
        description="opta is an enhanced Claude Code CLI in your terminal",
    ...
    from opta import coders as _opta_coders

    edit_format_choices = sorted(
        {
            c.edit_format
            for c in _opta_coders.__all__
    ...
    group.add_argument(
        ...
        default=".opta.model.settings.yml",
        help="Specify a file with opta model settings for unknown models",
    ).complete = shtab.FILE
    group.add_argument(
        "--model-metadata-file",
        metavar="MODEL_METADATA_FILE",
        default=".opta.model.metadata.json",
    ...
    default_input_history_file = (
        os.path.join(git_root, ".opta.input.history") if git_root else ".opta.input.history"
    )
    default_chat_history_file = (
        os.path.join(git_root, ".opta.chat.history.md") if git_root else ".opta.chat.history.md"
    )
    group.add_argument(
        "--input-history-file",
    ...
    group.add_argument(
        ...
        default=None,
        help="Log the conversation with the LLM to this file (for example, .opta.llm.history)",
    ).complete = shtab.FILE
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Enable/disable adding .opta* to .gitignore (default: True)",
    )
    group.add_argument(
        "--add-gitignore-files",
        action=argparse.BooleanOptionalAction,
    ...
    default_optaignore_file = (
        os.path.join(git_root, ".optaignore") if git_root else ".optaignore"
    )

    group.add_argument(
        "--optaignore",
        metavar="AIDERIGNORE",
        type=lambda path_str: resolve_optaignore_path(path_str, git_root),
        default=default_optaignore_file,
        help="Specify the opta ignore file (default: .optaignore in git root)",
    ).complete = shtab.FILE
    group.add_argument(
        "--subtree-only",
        action="store_true",
    ...
    group.add_argument(
        ...
        default=None,
        help=(
            "Attribute opta code changes in the git author name (default: True). If explicitly set"
    ...
    group.add_argument(
        ...
        default=None,
        help=(
            "Attribute opta commits in the git committer name (default: True). If explicitly set"
            " to True, overrides --attribute-co-authored-by precedence for opta edits."
        ),
    )
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Prefix commit messages with 'opta: ' if opta authored the changes (default: False)",
    )
    group.add_argument(
        "--attribute-commit-message-committer",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Prefix all commit messages with 'opta: ' (default: False)",
    )
    group.add_argument(
        ...
        default=True,
        help=(
            "Attribute opta edits using the Co-authored-by trailer in the commit message"
    ...
    group.add_argument(
        "--check-update",
        action=argparse.BooleanOptionalAction,
        help="Check for new opta versions on launch",
        default=True,
    )
    group.add_argument(
        "--show-release-notes",
    ...
    group.add_argument(
        ...
        "--update",
        action="store_true",
        help="Upgrade opta to the latest version from PyPI",
        default=False,
    )
    group.add_argument(
        "--version",
    ...
    group.add_argument(
        ...
        "--browser",
        action=argparse.BooleanOptionalAction,
        help="Run opta in your browser (default: False)",
        default=False,
    )
    group.add_argument(
        "--copy-paste",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Enable automatic copy/paste of chat between opta and web UI (default: False)",
    )
    group.add_argument(
        "--apply",
        metavar="FILE",
    ...
    group.add_argument(
        ...
        metavar="CONFIG_FILE",
        help=(
            "Specify the config file (default: search for .opta.conf.yml in git root, cwd"
            " or home directory)"
        ),
    ).complete = shtab.FILE
    ...
    group.add_argument(
        ...
        help=(
            ...
            f" {', '.join(supported_shells_list)}. Example: opta --shell-completions bash"
        ),
    )
