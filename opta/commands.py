...
from opta import models, prompts, voice
from opta.editor import pipe_editor
from opta.format_settings import format_settings
from opta.help import Help, install_help_extra
from opta.io import CommandCompletionException
from opta.llm import litellm
from opta.repo import ANY_GIT_ERROR
from opta.run_cmd import run_cmd
from opta.scrape import Scraper, install_playwright
from opta.utils import is_image_file
...
class Commands:
    ...
    def cmd_chat_mode(self, args):
        ...
        show_formats = OrderedDict(
            [
                ("help", "Get help about using opta (usage, config, troubleshoot)."),
    ...
    def cmd_undo(self, args):
        "Undo the last git commit if it was done by opta"
        try:
    ...
    def raw_cmd_undo(self, args):
        ...
        if last_commit_hash not in self.coder.opta_commit_hashes:
            self.io.tool_error("The last commit was not made by opta in this chat session.")
            self.io.tool_output(
    ...
    def cmd_add(self, args):
        "Add files to the chat so opta can edit them or review them in detail"
        ...
        for word in filenames:
            ...
            if self.coder.repo and self.coder.repo.ignored_file(fname):
                self.io.tool_warning(f"Skipping {fname} due to optaignore or --subtree-only.")
                continue
    ...
    def basic_help(self):
        ...
        self.io.tool_output()
        self.io.tool_output("Use `/help <question>` to ask questions about how to use opta.")

    def cmd_help(self, args):
        "Ask questions about opta"
...
"""
    ...
    def cmd_report(self, args):
        ...
        from opta.report import report_github_issue
